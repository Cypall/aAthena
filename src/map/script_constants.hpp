...
#define SCRIPT_CONSTANTS_HPP
	...
	// custom job
	export_constant(JOB_DEATHKNIGHT);
	...
	// custom job
	// male+female same job name
	export_constant(JOB_DARK_KNIGHT);
	// male name only
	export_constant(JOB_HOKAGE);
	// female name only
	export_constant(JOB_BUSTY_ARCHBISHOP);
	// male+female differrence job name
	...
	// custom job
	export_constant2("EAJ_DEATHKNIGHT",MAPID_DEATHKNIGHT);
	...
	// custom job class 4
	export_constant2("EAJ_ORACLE", MAPID_ORACLE);

	// custom job
	export_constant2("EAJ_DARK_KNIGHT", MAPID_DARK_KNIGHT);
	export_constant2("EAJ_HOKAGE", MAPID_HOKAGE);
	export_constant2("EAJ_BUSTY_ARCHBISHOP", MAPID_BUSTY_ARCHBISHOP);
