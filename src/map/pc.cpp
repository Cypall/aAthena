...
uint64 pc_jobid2mapid(unsigned short b_class)
{
	...
	// custom job
		case JOB_ORACLE:               return MAPID_ORACLE;
		case JOB_DARK_KNIGHT:          return MAPID_DARK_KNIGHT;
		case JOB_HOKAGE:               return MAPID_HOKAGE;
		case JOB_BUSTY_ARCHBISHOP:     return MAPID_BUSTY_ARCHBISHOP;
	//Unknown
		default:
			return -1;
	}
...
int pc_mapid2jobid(uint64 class_, int sex)
{
	...
	// custom job
		case MAPID_ORACLE:               return JOB_ORACLE;
		case MAPID_DARK_KNIGHT:          return JOB_DARK_KNIGHT;
		case MAPID_HOKAGE:               return JOB_HOKAGE;
		case MAPID_BUSTY_ARCHBISHOP:     return JOB_BUSTY_ARCHBISHOP;
	//Unknown
		default:
			return -1;
	}
...
const char* job_name(int class_)
{
	...
	case JOB_DARK_KNIGHT:
		return msg_txt(NULL, 814);
	case JOB_HOKAGE:
		return msg_txt(NULL, 815);
	case JOB_BUSTY_ARCHBISHOP:
		return msg_txt(NULL, 816);
